...
def eiler11(x1,x2,x3,x4):
    a=[]
    for i in range(20):
        if i<3:
            a.append(x4[i]*x3[i]*x2[i]*x1[i])
            a.append(x4[i] * x3[i+1] * x2[i+2] * x1[i+3])
            a.append(x4[i] * x4[i + 1] * x4[i + 2] * x4[i + 3])
    ...
    for i in range(17):
        a.append(x1[i]*x1[i+1]*x1[i+2]*x1[i+3])
        a.append(x2[i] * x2[i + 1] * x2[i + 2] * x2[i + 3])
        a.append(x3[i] * x3[i + 1] * x3[i + 2] * x3[i + 3])
    a=max(a)
    return(a)

A.append(eiler11(a0,a1,a2,a3))
A.append(eiler11(a3,a4,a5,a6))
A.append(eiler11(a6,a7,a8,a9))
A.append(eiler11(a9,a10,a11,a12))
A.append(eiler11(a12,a13,a14,a15))
A.append(eiler11(a15,a16,a17,a18))
A.append(eiler11(a16,a17,a18,a19))
A=max(A)
print(A)